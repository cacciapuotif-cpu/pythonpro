...
def http_context(tmp_path):
    ...
    current_user = SimpleNamespace(id=actor.id, role="consultazione")
    app = FastAPI()
    app.include_router(attivita_router.router)
    app.dependency_overrides[get_db] = lambda: session
    app.dependency_overrides[attivita_router.get_current_user] = lambda: current_user
